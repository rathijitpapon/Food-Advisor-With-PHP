      ...
      <div class="row">
        <div class="col-md-4 offset-md-4 form-div">
          <form action="owner_sign_up.php" method="post">
            <h3 class="text-center"><b>Register As Restaurant Owner</b></h3>
            ...
            <div class="form-group">
              <button type="submit" name="signup-btn-owner" class="btn btn-primary btn-block btn-lg">Sign Up</button>
            </div>
            <p class="text-center">Already have a account? <a href="login_owner.php">Sign In</a> </p>
          </form>
        </div>
      </div>
    </div>
