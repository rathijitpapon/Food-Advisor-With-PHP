...
<body>
  ...
  <?php  
    if(count($food_output) > 0){
    for($cnt = 0;$cnt < count($food_output['res_id']);$cnt++){?>
...
cursor: pointer;" name="<?php echo $food_output['res_id'][$cnt]; ?>"><img src="<?php $id=$food_output['res_id'][$cnt]; echo "restaurant/$id.jpg"; ?>" alt="r1" width="450" height="260"></button>
            </div>
          </div>
        </div>
        <div class="rightcolumn">
          <div class="card">
            <div class="fakeimg" style="height:300px;">
              <button type="hidden" style="background-color: lightblue; border-style:none;
cursor: pointer;" name="<?php echo $food_output['res_id'][$cnt]; ?>"><h2><b><?php echo $food_output['res_name'][$cnt] ?></b></a></button>
              <br>
              <h4><b><?php echo $food_output['area'][$cnt]; echo " , "; echo $food_output['district'][$cnt];
                        echo " , "; echo $food_output['country'][$cnt]; ?></b></h4>
              <br>
              <br>
              <h4><b><?php echo "Item: ";  echo $food_output['food_name'][$cnt]; ?></p></b></h4>
              <h4><b><?php echo "Price: "; echo $food_output['price'][$cnt]; ?></p></b></h4>
              <h4><b><?php echo "Rating: ";echo $food_output['rating'][$cnt]; ?></p></b></h4>
            </div>
          </div>
        </div>
      </div>
